...
protected:
  ...
  /// add it as a dependency to a lattice anchor. That is, every time the lattice
  /// after anchor is updated, the dependent program point must be visited, and
...
protected:
  ...
  /// Get the dense lattice before the execution of the program point in `anchor`
