...
template bool
mlir::hasEffect<MemoryEffects::Write, MemoryEffects::Free>(Operation *, Value value);
...
template bool
mlir::hasEffect<OpOperand *, MemoryEffects::Write, MemoryEffects::Free>(Operation *, OpOperand *);
...
template bool
mlir::hasEffect<OpResult, MemoryEffects::Write, MemoryEffects::Free>(Operation *, OpResult);
...
template bool
mlir::hasEffect<BlockArgument, MemoryEffects::Write, MemoryEffects::Free>(Operation *, BlockArgument);
